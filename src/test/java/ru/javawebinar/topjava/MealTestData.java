...
public class MealTestData {
    ...
    public static final int WITHOUT_ROLE_MEAL_ID = START_SEQ + 13;
    ...
    public static final Meal mealTest = new Meal(START_SEQ + 13, of(2020, Month.JANUARY, 30, 10, 0), "Завтрак", 500);
